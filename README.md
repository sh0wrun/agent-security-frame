...
📘 **整本 PDF**:见 [Releases 页](../../releases) 下载最新版本(178 页 / ~7.5 MB,v3.1)

🌐 **在线浏览交互式原型**:<https://sh0wrun.github.io/agent-security-frame/>(7 个 tab,GitHub Pages 托管)
...
| 第 10 章 | [真实案例深析](v3_第10章_真实案例深析.md) | 6 案例:邮件助手记忆投毒 / SSRF→Token→Exec / Crescendo / yahoofinance Skill / **授权传播失效 SIF(cross/I)** / **Viral Agent Loop 生成式蠕虫(cross/K)** |
| 附录 A | [攻防全量映射表](v3_附录A_攻防全量映射表.md) | 12 攻击面 × 4 层 / 7 对抗技术触达表 / §A.7 涌现型攻击事后检测路径 / 三方分类法索引 |
| 附录 B | [测试库与验证接口 Schema](v3_附录B_测试库与验证接口Schema.md) | 8 测试集合 / YAML 用例 Schema / 4 接口 JSON Schema |
| 附录 C | [R 编号 × 章节 引用矩阵](v3_附录C_R编号引用矩阵.md) | R 编号 × 10 章引用矩阵 + 核心论据材料(v3.1 新增 R25/R30/R32/R35/R37/R38) |
| 附录 D | [可执行评估分发包](v3_附录D_可执行评估分发包.md) | ASF v3.1 在书稿叙事之外同步分发的 `asf-eval/` drop-in 评估包说明(D.1–D.8) |

---

## 在线浏览交互式原型

主页面 <https://sh0wrun.github.io/agent-security-frame/> 自动进入 v3 主原型,7 个 tab 完整可点:

| Tab | 锚点 | 内容 |
|--|--|--|
| 全景图 | [`#tab=overview`](https://sh0wrun.github.io/agent-security-frame/prototypes/v3-skeleton/skeleton-A.html) | 4 层 × CIK 矩阵,可切换显示 6 方案的覆盖叠加 |
| 设计原则 | [`#tab=principles`](https://sh0wrun.github.io/agent-security-frame/prototypes/v3-skeleton/v3-prototype.html#tab=principles) | 4 原则 + 14 立论卡片 |
| 架构层 | [`#tab=arch`](https://sh0wrun.github.io/agent-security-frame/prototypes/v3-skeleton/v3-prototype.html#tab=arch) | 7 层智能体架构 + OpenClaw 实例化映射 |
| 攻击面 | [`#tab=surfaces`](https://sh0wrun.github.io/agent-security-frame/prototypes/v3-skeleton/v3-prototype.html#tab=surfaces) | 12 攻击面卡片 |
| CIK 验证维度 | [`#tab=cik`](https://sh0wrun.github.io/agent-security-frame/prototypes/v3-skeleton/v3-prototype.html#tab=cik) | CIK 三维 + 4 层 = 12 验证矩阵 |
| 方案对比 | [`#tab=schemes`](https://sh0wrun.github.io/agent-security-frame/prototypes/v3-skeleton/v3-prototype.html#tab=schemes) | 6 方案"防护形状"并排迷你矩阵 |
| 工具链 | [`#tab=tools`](https://sh0wrun.github.io/agent-security-frame/prototypes/v3-skeleton/v3-prototype.html#tab=tools) | 28 工具的全景视图 |

也可 clone 仓库后直接 `open prototypes/v3-skeleton/v3-prototype.html`(完全离线可用,React/Babel 已打包入 `vendor/`)。
...
- **内部文档**(AI-Sentinel 商业 PRD 等):受发布方约束不公开,仓库仅保留章节中的引用与摘要(v3.1 已退役 R1 奇安信 / R2 SlowMist / R13a 腾讯 / R13b 治理白皮书,转向国际权威源)
